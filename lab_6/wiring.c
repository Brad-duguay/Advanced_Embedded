...
void on_LED(int pin, int position){ //bitshift a 1 bit to the bit position where the GPIO pin corresponds to the bit number
	int MASK = 1;
	MASK = (1 << pin);
...
void off_LED(int pin, int position){ //bitshift a 1 bit to the bit position where the GPIO pin corresponds to the bit number
	int MASK = 1;
	MASK = (1 << pin);
